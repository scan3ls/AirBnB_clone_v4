...
$(document).ready(function () {
  ...
  $.get('http://localhost:5001/api/v1/status/', function (data, textStatus) { // TODO: change localhost to 0.0.0.0
  ...
  $.ajax({
    url: 'http://localhost:5001/api/v1/places_search/', // TODO: change localhost to 0.0.0.0
    type: 'POST',
